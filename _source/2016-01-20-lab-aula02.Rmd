...
Vamos utilizar a planilha [_siglas_](), que contém a definição das variáveis e os dados do `pnud`, que contêm as informações demográficas e socioeconômicas por município brasileiro.
