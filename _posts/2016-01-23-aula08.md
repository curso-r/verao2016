...
{% highlight text %}
## 
## Laplace's Demon was called on Thu Jan 14 12:04:08 2016
## 
...
##      Covar=NULL, Iterations=1e+06, Status=900900, Thinning=1000,
...
{% highlight text %}
## Error in varify.variables(data, formula, startweights, learningrate.limit, : objeto 'trainingdata' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in print(net.sqrt): objeto 'net.sqrt' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in plot(net.sqrt): objeto 'net.sqrt' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in compute(net.sqrt, testdata): objeto 'net.sqrt' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in as.vector(net.results$net.result): objeto 'net.results' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in print(cleanoutput): objeto 'cleanoutput' não encontrado
{% endhighlight %}
