...
{% highlight text %}
## Error in mean(dados$aleatorio2): object 'dados' not found
{% endhighlight %}
...
{% highlight text %}
## Error in median(dados$aleatorio2): object 'dados' not found
{% endhighlight %}
...
{% highlight text %}
## Error in is.data.frame(x): object 'dados' not found
{% endhighlight %}
...
{% highlight text %}
## Error in quantile(dados$aleatorio2, probs = c(0.25, 0.75)): object 'dados' not found
{% endhighlight %}
...
{% highlight text %}
## Error in table(dados$cor): object 'dados' not found
{% endhighlight %}
...
{% highlight text %}
## Error in table(dados$cor, dados$cor): object 'dados' not found
{% endhighlight %}
