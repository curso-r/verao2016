...
{% highlight text %}
## Error in summary(dados): objeto 'dados' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in summary(dados$aleatorio2): objeto 'dados' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in mean(dados$aleatorio2): objeto 'dados' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in median(dados$aleatorio2): objeto 'dados' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in quantile(dados$aleatorio2, probs = c(0.25, 0.75)): objeto 'dados' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in table(dados$cor): objeto 'dados' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in table(dados$cor, dados$cor): objeto 'dados' não encontrado
{% endhighlight %}
