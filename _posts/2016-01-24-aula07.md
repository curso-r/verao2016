...
![plot of chunk unnamed-chunk-2](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-2-1.png) 
...
![plot of chunk unnamed-chunk-2](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-2-2.png) 
...
![plot of chunk unnamed-chunk-3](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-3-1.png) 
...
![plot of chunk unnamed-chunk-6](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-6-1.png) 
...
![plot of chunk unnamed-chunk-8](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-8-1.png) 
...
{% highlight text %}
## Error in eval(expr, envir, enclos): não foi possível encontrar a função "linearHypothesis"
{% endhighlight %}
...
![plot of chunk unnamed-chunk-25](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-25-1.png) 
...
![plot of chunk unnamed-chunk-28](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-28-1.png) 
...
![plot of chunk unnamed-chunk-30](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-30-1.png) 
...
{% highlight text %}
## Error in eval(expr, envir, enclos): não foi possível encontrar a função "lmer"
{% endhighlight %}
...
{% highlight text %}
## Error in summary(modelo): objeto 'modelo' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): não foi possível encontrar a função "tree"
{% endhighlight %}
...
{% highlight text %}
## Error in summary(ajuste_tree): objeto 'ajuste_tree' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in plot(ajuste_tree): objeto 'ajuste_tree' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in text(ajuste_tree, pretty = 0): objeto 'ajuste_tree' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): não foi possível encontrar a função "cv.tree"
{% endhighlight %}
...
{% highlight text %}
## Error in plot(cv_tree): objeto 'cv_tree' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): não foi possível encontrar a função "prune.tree"
{% endhighlight %}
...
{% highlight text %}
## Error in plot(melhor_tree): objeto 'melhor_tree' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in text(melhor_tree, pretty = 0): objeto 'melhor_tree' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in predict(melhor_tree): objeto 'melhor_tree' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): não foi possível encontrar a função "tree.control"
{% endhighlight %}
...
![plot of chunk unnamed-chunk-39](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-39-1.png) 
...
![plot of chunk unnamed-chunk-40](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-40-1.png) 
...
![plot of chunk unnamed-chunk-41](http://curso-r.github.io/verao2016/images/2016-01-24-aula07/unnamed-chunk-41-1.png) 
...
{% highlight text %}
## Warning in data(tea): data set 'tea' not found
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): objeto 'tea' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): objeto 'newtea' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): objeto 'cats' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): não foi possível encontrar a função "MCA"
{% endhighlight %}
...
{% highlight text %}
## Error in data.frame(mca$var$coord, variavel = rep(names(cats), cats), : objeto 'mca' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in data.frame(mca$ind$coord): objeto 'mca' não encontrado
{% endhighlight %}
...
{% highlight text %}
## Error in do.call("layer", list(mapping = mapping, data = data, stat = stat, : objeto 'mca1_vars_df' não encontrado
{% endhighlight %}
